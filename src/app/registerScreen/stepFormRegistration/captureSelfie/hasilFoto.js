...
import { PADDING_TOP } from '../../../../utils/const'
...
const HasilFotoScreen = ({navigation, route}) => {
    ...
    handleLanjutkan = async() => {
      ...
      if(imageSource != ''){
        ...
        navigation.navigate("KodeReferralRegister", {photo: 'a'});
      }
    }
    ...
    <View style={styles.hasilFotoPage}>
      ...
      <View style={{justifyContent: 'space-between', flex: 1}}>
        <View style={styles.section}>
          ...
          {imageSource != '' ? <Image source={{uri: `file://${imageSource}`}} style={styles.imageSelfie}/> : <></>} 
        </View>
