  ...
  return (
    <SafeAreaView style={{flex:1, backgroundColor: Color.neutralZeroOne}}>
        ...
        <View style={styles.section}>
            ...
            <CustomInput inputNotWrong={isPassword} value={password} setValue={setPassword} type={show? "text" : "password"} rightPress={() => setShow(!show)}
                 iconRight={show ? "eye" : "eye-off"}
            />
            ...
            <CustomInput inputNotWrong={isPasswordMatch} value={confirmPassword} setValue={setConfirmPassword} type={showConfirm? "text" : "password"} rightPress={() => setShowConfirm(!showConfirm)}
                iconRight={showConfirm ? "eye" : "eye-off"}
            />
