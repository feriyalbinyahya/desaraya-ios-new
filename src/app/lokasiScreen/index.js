    ...
    <View style={{flex:1, backgroundColor: Color.neutralZeroOne}}>
        ...
        <View style={styles.container}>
            ...
            <View style={styles.bottomSection}>
                <View style={styles.buttonContinue}><CustomButton onPress={handleLanjutkan} disabled={!isLocation} height={40} 
                fontStyles={{color: Color.neutralZeroOne, ...FontConfig.button3}} 
                backgroundColor={Color.primaryMain} text="Lanjutkan" /></View>
            </View>
        </View>   
    </View> :
    <View style={{flex:1, backgroundColor: Color.neutralZeroOne}}>
